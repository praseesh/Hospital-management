    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medicine_bill', models.FloatField(blank=True, null=True)),
                ('labreport_bill', models.IntegerField(blank=True, null=True)),
                ('total_amount', models.DecimalField(decimal_places=2, max_digits=10)),
                ('payment_method', models.CharField(choices=[('cash', 'Cash'), ('credit_card', 'Credit Card'), ('debit_card', 'Debit Card'), ('paypal', 'PayPal'), ('razorpay', 'Razorpay')], max_length=255)),
                ('description', models.CharField(blank=True, max_length=255)),
                ('status', models.CharField(max_length=50)),
                ('date', models.DateField()),
                ('patient_id', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='staff.patientbills')),
            ],
            options={
                'db_table': 'invoice',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.CharField(choices=[('Sugar Test', 'Sugar Test'), ('Cholesterol Test', 'Cholesterol Test'), ('Liver Test', 'Liver Test'), ('Kidney Test', 'Kidney Test')], max_length=100)),
                ('date', models.DateField()),
